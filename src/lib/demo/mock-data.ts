/**
 * Demo mode mock data for Reclaim AI.
 *
 * Typed, well-documented mock data for the full dashboard experience:
 * clients, invoices, sequences, campaigns, analytics, email logs,
 * upcoming actions, and dashboard stats.
 *
 * All data is static — no database writes, no side effects.
 * Imported by state.ts to produce the full DemoState object.
 */
...
// ── Mock Data ───────────────────────────────────────────────────────────
// All amounts in USD cents. Ages are relative (computed at call time).

/** 4 realistic clients across different industries. */
...
/** 5 invoices: 2 past-due ($4,500 + $2,850), 1 open ($1,200), 2 paid ($6,750 + $3,100). */
...
/** The default 3-step dunning sequence shown in the demo. */
export function buildDefaultSequence(): DemoSequence {
  return {
    id: 'demo-seq-1',
...
/** 3 campaigns: 2 active, 1 recovered. */
...
/** 4 recent email logs showing a realistic delivery funnel. */
export const EMAIL_LOGS: DemoEmailLog[] = [
  { id: 'demo-log-1', recipient_email: 'sarah@brightpath.co', status: 'sent', sent_at: daysAgo(2), invoice_number: 'INV-2026-0142' },
  { id: 'demo-log-2', recipient_email: 'marcus@webbinteractive.com', status: 'opened', sent_at: daysAgo(1), invoice_number: 'INV-2026-0138' },
  { id: 'demo-log-3', recipient_email: 'james@okonkwoconsulting.com', status: 'delivered', sent_at: daysAgo(4), invoice_number: 'INV-2026-0135' },
  { id: 'demo-log-4', recipient_email: 'sarah@brightpath.co', status: 'delivered', sent_at: daysAgo(3), invoice_number: 'INV-2026-0142' },
]

/** 2 upcoming scheduled actions. */
export const UPCOMING_ACTIONS: DemoUpcomingAction[] = [
  { id: 'demo-action-1', invoice_number: 'INV-2026-0142', next_action_at: daysFromNow(12), step_number: 2, client_name: 'Sarah Chen' },
  { id: 'demo-action-2', invoice_number: 'INV-2026-0138', next_action_at: daysFromNow(15), step_number: 2, client_name: 'Marcus Webb' },
]

/** Full analytics snapshot for the demo. */
export const ANALYTICS: DemoAnalytics = {
  summary: {
...
export const STATS: DemoDashboardStats[] = [
